export const C = {
  bg:"#0c0c0c", card:"#141414", card2:"#1a1a1a", input:"#1c1c1c",
  border:"#222", text:"#eaeaea", sub:"#888", dim:"#4a4a4a",
  green:"#34d399", red:"#f06272", yellow:"#f0b840",
  accent:"#e2621a", purple:"#8b5cf6", blue:"#3b82f6",
};

export const BRANDS: Record<string,{name:string;color:string;bg:string;tc?:string}> = {
  nubank:{name:"Nubank",color:"#8b2fd4",bg:"linear-gradient(135deg,#8b2fd4,#6b21a8)"},
  c6:{name:"C6 Bank",color:"#ccc",bg:"linear-gradient(135deg,#2a2a2a,#111)",tc:"#e5e5e5"},
  ...
  itau:{name:"Itaú",color:"#ec7000",bg:"linear-gradient(135deg,#003a70,#002952)",tc:"#ff8c00"},
  bradesco:{name:"Bradesco",color:"#cc092f",bg:"linear-gradient(135deg,#cc092f,#8b0620)"},
  bb:{name:"Banco do Brasil",color:"#f9e300",bg:"linear-gradient(135deg,#003882,#002860)",tc:"#f9e300"},
  caixa:{name:"Caixa",color:"#005ca9",bg:"linear-gradient(135deg,#005ca9,#f37021)",tc:"#fff"},
  pan:{name:"Pan",color:"#00b4e6",bg:"linear-gradient(135deg,#00b4e6,#0090b8)"},
  midway:{name:"Midway",color:"#ffc600",bg:"linear-gradient(135deg,#333,#1a1a1a)",tc:"#ffc600"},
...
export const cm = new Date().getMonth()+1;
export const cd = new Date().getDate();
export const dim = new Date(new Date().getFullYear(), cm, 0).getDate();
export const dleft = dim - cd;
export const fmtD = (d:any,m:any) => `${String(d||1).padStart(2,"0")}/${String(m||cm).padStart(2,"0")}`;
let _id=100; export const uid=()=>++_id;
